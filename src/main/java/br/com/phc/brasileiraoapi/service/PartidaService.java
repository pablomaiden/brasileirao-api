...
public class PartidaService {	
	...
	public void atualizaPartida(Partida partida, PartidaGoogleDTO partidaGoogle) {
		  ...
		  partida.setPlacarEstendidoEquipeCasa(partidaGoogle.
		  getPlacarEstendidoEquipeCasa());
		  partida.setPlacarEstendidoEquipeVisitante(partidaGoogle.
		  getPlacarEstendidoEquipeVisitante());
